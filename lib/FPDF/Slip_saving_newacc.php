...
$total = number_format($FEE + str_replace(',', '', $amount),2) ;
...
$pdf->Cell( 10  , 0 , iconv( 'UTF-8','cp874' , 'เปิดบัญชีออมทรัพย์' ) , 0 , 0 ,'L' );
...
$pdf->Ln(6);
$pdf->Cell( 15  , 0 , iconv( 'UTF-8','cp874' , 'ค่าธรรมเนียม' ) , 0 , 0 ,'L' );
$pdf->Cell( 48  , 0 , iconv( 'UTF-8','cp874' , $FEE ) , 0 , 0 ,'R' );
$pdf->Cell( 9  , 0 , iconv( 'UTF-8','cp874' , 'บาท' ) , 0 , 0 ,'R' );

$pdf->Ln(12);
$pdf->Cell( 15  , 0 , iconv( 'UTF-8','cp874' , 'จำนวนเงินคงเหลือ' ) , 0 , 0 ,'L' );
